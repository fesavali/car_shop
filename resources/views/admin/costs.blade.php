...
<div class="container" style="padding-bottom:20px;padding-top:10px;">
  ...
  <div class="card-body">
    ...
    <a href="{{ route('edit_cost', [$pack->id, $admin->id]) }}" class="btn btn-primary">Edit Cost</a>
    <a href="{{ route('del_cost', [$pack->id, $admin->id]) }}" class="btn btn-danger">Delete Plan</a>
    
  </div>
  
  <div class="card-footer text-muted">Amount users will be charged to post</div>
</div>
    </div>
    @endforeach
    @else
