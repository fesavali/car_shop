...
<div class="col-md" style="background-color: rgba(255, 255, 255, 0.7); padding-top: 20px; border-radius:10px; padding-right: 10px; padding-left:10px;">
    ...
    <form action="{{ route('update_car',[$vehicle->id, $admin->id]) }}" method="POST">
    {{ csrf_field() }}
...
<div class="container-fluid" style="padding-top:10px; padding-bottom:15px;">
  <label>Transaction Code</label>
    <input id="duration" class="form-control" type="text" name="trans_id" value="{{ $vehicle->trans_id }}" placeholder="Transaction Code" required>
  </div> 
  <div class="container-fluid" style="padding-top:10px; padding-bottom:15px;">
  <label>Package</label>
    <input id="duration" class="form-control" type="text" name="package" value="{{ $vehicle->package }}" placeholder="Package" required>
  </div> 
  <div class="container-fluid" style="padding-top:10px; padding-bottom:15px;">
