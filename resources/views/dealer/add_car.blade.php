...
<!-- show error messages -->
  ...
  @endif
<!--upload form here -->
<form action="{{ route('dsavecar', [$user->id]) }}" method="POST" enctype="multipart/form-data">
{{ csrf_field() }}
...
<div class="col-6 col-lg-4">
  ...
  <span class="instructions">Images will be automatically resized to fit 
        ...
        <span class="instructions-cont">You may upload up to a minimum of 5 images and each image may be no larger than 5MB</span>
  </div>
