...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #151E27; border-radius:10px;">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <!-- Navbar brand -->
      <a class="navbar-brand mt-2 mt-lg-0" href="{{ route('ddash', $user->id) }}">
        <h3 style="font-family:Garamond; color:white;">CaRShop | CardealeR</h3>
        </a>
      <!-- Left links -->
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
      <li class="nav-item">
          <a class="nav-link" style="font-family:Garamond; color:white;" href="{{ route('ddash', $user->id) }}">Dashboard</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" style="font-family:Garamond; color:white;" href="{{ route('dlisted', $user->id) }}">My Cars</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" style="font-family:Garamond; color:white;" href="#1">Subscriptions</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" style="font-family:Garamond; color:white;" href="{{ route('dsells', $user->id) }}">Sells</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" style="font-family:Garamond; color:white;" href="{{ route('dcar', $user->id) }}">Add Car</a>
        </li>
