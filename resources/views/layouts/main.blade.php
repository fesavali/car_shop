...
<!-- favicon -->
<link rel="shortcut icon" href="{{ url('public/images/favicon/favicon.ico') }}">
<link rel="apple-touch-icon" sizes="57x57" href="{{ url('public/images/favicon/apple-touch-icon.png') }}">
<link rel="apple-touch-icon" sizes="192x192" href="{{ url('public/images/favicon/android-chrome-192x192.png') }}">
<link rel="apple-touch-icon" sizes="512x512" href="{{ url('public/images/favicon/android-chrome-512x512.png') }}">
<link rel="apple-touch-icon" sizes="16x16" href="{{ url('public/images/favicon/favicon-16x16.png') }}">
<link rel="apple-touch-icon" sizes="32x32" href="{{ url('public/images/favicon/favicon-32x32.png') }}">
...
<div class="col-md-4 d-flex justify-content-end" style="padding-top: 25px; padding-left: 20px; "><h5 style="font-family:Garamond;"><b><a href="https://wa.me/message/KRBAQWH57AXAE1" target="_blank"><i class="far fa-comment me-3"></i> WhatsApp</a> or <i class="far fa fa-phone me-3"></i>+254 792 567 464</b></h5></div>
</div>
