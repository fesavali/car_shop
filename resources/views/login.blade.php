...
@section('content')
  ...
  <div class="row">
    ...
    <span class="badge bg-info" style="width: 100%; padding-top:10px;padding-bottom:10px; background-color: rgba(0, 0, 0, 0.9) !Important;">LOGIN TO ACCESS DASHBOARD.</span>
    </div>
